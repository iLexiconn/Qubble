...
public abstract class Tuple2d implements java.io.Serializable, Cloneable {
     ...
     */
    public Tuple2d(javax.vecmath.Tuple2d t1) {
        this.x = t1.x;
        this.y = t1.y;
    }
     ...
     */
    public Tuple2d(javax.vecmath.Tuple2f t1) {
        this.x = (double) t1.x;
        this.y = (double) t1.y;
    }
     ...
     */
    public final void add(javax.vecmath.Tuple2d t1, javax.vecmath.Tuple2d t2) {
        this.x = t1.x + t2.x;
        this.y = t1.y + t2.y;
    }
     ...
     */
    public final void add(javax.vecmath.Tuple2d t1) {
        this.x += t1.x;
        this.y += t1.y;
    }
     ...
     * @param t2 the second tuple
     */
    public final void sub(javax.vecmath.Tuple2d t1, javax.vecmath.Tuple2d t2) {
        this.x = t1.x - t2.x;
        this.y = t1.y - t2.y;
    }
     ...
     */
    public final void sub(javax.vecmath.Tuple2d t1) {
        this.x -= t1.x;
        this.y -= t1.y;
    }
     ...
     */
    public final void negate(javax.vecmath.Tuple2d t1) {
        this.x = -t1.x;
        this.y = -t1.y;
    }
     ...
     */
    public final void scale(double s, javax.vecmath.Tuple2d t1) {
        this.x = s * t1.x;
        this.y = s * t1.y;
    }
     ...
     */
    public final void scaleAdd(double s, javax.vecmath.Tuple2d t1, javax.vecmath.Tuple2d t2) {
        this.x = s * t1.x + t2.x;
        this.y = s * t1.y + t2.y;
    }
     ...
     */
    public final void scaleAdd(double s, javax.vecmath.Tuple2d t1) {
     ...
     */
    public boolean equals(javax.vecmath.Tuple2d t1) {
        try {
    ...
    public boolean equals(Object t1) {
        try {
            javax.vecmath.Tuple2d t2 = (javax.vecmath.Tuple2d) t1;
     ...
     * @return true or false
     */
    public boolean epsilonEquals(javax.vecmath.Tuple2d t1, double epsilon) {
        double diff;
     ...
     */
    public final void clamp(double min, double max, javax.vecmath.Tuple2d t) {
        if (t.x > max) {
            x = max;
        } else if (t.x < min) {
            x = min;
     ...
     * @param t   the source tuple, which will not be modified
     */
    public final void clampMin(double min, javax.vecmath.Tuple2d t) {
        if (t.x < min) {
            x = min;
        } else {
            x = t.x;
     ...
     * @param t   the source tuple, which will not be modified
     */
    public final void clampMax(double max, javax.vecmath.Tuple2d t) {
        if (t.x > max) {
            x = max;
        } else {
            x = t.x;
     ...
     * @param t the source tuple, which will not be modified
     */
    public final void absolute(javax.vecmath.Tuple2d t) {
        x = Math.abs(t.x);
        y = Math.abs(t.y);
    }
     ...
     */
    public final void interpolate(javax.vecmath.Tuple2d t1, javax.vecmath.Tuple2d t2, double alpha) {
     ...
     * @param alpha the alpha interpolation parameter
     */
    public final void interpolate(javax.vecmath.Tuple2d t1, double alpha) {
