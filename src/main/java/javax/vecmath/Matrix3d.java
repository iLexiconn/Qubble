...
public class Matrix3d implements java.io.Serializable, Cloneable {
     ...
     */
    public Matrix3d(javax.vecmath.Matrix3d m1) {
        this.m00 = m1.m00;
        this.m01 = m1.m01;
        this.m02 = m1.m02;
     ...
     */
    public final void getRow(int row, javax.vecmath.Vector3d v) {
        if (row == 0) {
            v.x = m00;
            v.y = m01;
            v.z = m02;
     ...
     * @param v      the vector into which the matrix row values will be copied
     */
    public final void getColumn(int column, javax.vecmath.Vector3d v) {
        if (column == 0) {
            v.x = m00;
            v.y = m10;
            v.z = m20;
     ...
     */
    public final void setRow(int row, javax.vecmath.Vector3d v) {
        switch (row) {
            case 0:
                this.m00 = v.x;
                this.m01 = v.y;
     ...
     */
    public final void add(double scalar, javax.vecmath.Matrix3d m1) {
     ...
     */
    public final void add(javax.vecmath.Matrix3d m1, javax.vecmath.Matrix3d m2) {
     ...
     */
    public final void add(javax.vecmath.Matrix3d m1) {
        this.m00 += m1.m00;
        this.m01 += m1.m01;
        this.m02 += m1.m02;
     ...
     * @param m2 the second matrix
     */
    public final void sub(javax.vecmath.Matrix3d m1, javax.vecmath.Matrix3d m2) {
        this.m00 = m1.m00 - m2.m00;
        this.m01 = m1.m01 - m2.m01;
        this.m02 = m1.m02 - m2.m02;
     ...
     * @param m1 the other matrix
     */
    public final void sub(javax.vecmath.Matrix3d m1) {
        this.m00 -= m1.m00;
        this.m01 -= m1.m01;
        this.m02 -= m1.m02;
     ...
     */
    public final void transpose(javax.vecmath.Matrix3d m1) {
        if (this != m1) {
            this.m00 = m1.m00;
            this.m01 = m1.m10;
            this.m02 = m1.m20;
     ...
     */
    public final void invert(javax.vecmath.Matrix3d m1) {
        invertGeneral(m1);
    }
     ...
     */
    private final void invertGeneral(javax.vecmath.Matrix3d m1) {
        ...
        if (!luDecomposition(tmp, row_perm)) {
            ...
            throw new SingularMatrixException(javax.vecmath.VecMathI18N.getString("Matrix3d12"));
        }
     ...
     */
    public final void mul(double scalar, javax.vecmath.Matrix3d m1) {
     ...
     * @param m1 the other matrix
     */
    public final void mul(javax.vecmath.Matrix3d m1) {
        double m00, m01, m02,
                m10, m11, m12,
                m20, m21, m22;
     ...
     * @param m2 the second matrix
     */
    public final void mul(javax.vecmath.Matrix3d m1, javax.vecmath.Matrix3d m2) {
        if (this != m1 && this != m2) {
     ...
     */
    public final void mulNormalize(javax.vecmath.Matrix3d m1) {
     ...
     */
    public final void mulNormalize(javax.vecmath.Matrix3d m1, javax.vecmath.Matrix3d m2) {
     ...
     * @param m2 the matrix on the right hand side of the multiplication
     */
    public final void mulTransposeBoth(javax.vecmath.Matrix3d m1, javax.vecmath.Matrix3d m2) {
        if (this != m1 && this != m2) {
     ...
     * @param m2 the matrix on the right hand side of the multiplication
     */
    public final void mulTransposeRight(javax.vecmath.Matrix3d m1, javax.vecmath.Matrix3d m2) {
        if (this != m1 && this != m2) {
     ...
     * @param m2 the matrix on the right hand side of the multiplication
     */
    public final void mulTransposeLeft(javax.vecmath.Matrix3d m1, javax.vecmath.Matrix3d m2) {
        if (this != m1 && this != m2) {
     ...
     */
    public final void normalize(javax.vecmath.Matrix3d m1) {
     ...
     * @param m1 Provides the matrix values to be normalized
     */
    public final void normalizeCP(javax.vecmath.Matrix3d m1) {
     ...
     */
    public boolean equals(javax.vecmath.Matrix3d m1) {
        try {
    ...
    public boolean equals(Object t1) {
        try {
            javax.vecmath.Matrix3d m2 = (javax.vecmath.Matrix3d) t1;
     ...
     */
    public boolean epsilonEquals(javax.vecmath.Matrix3d m1, double epsilon) {
        double diff;
     ...
     * @param m1 the source matrix
     */
    public final void negate(javax.vecmath.Matrix3d m1) {
        this.m00 = -m1.m00;
        this.m01 = -m1.m01;
        this.m02 = -m1.m02;
    ...
    public Object clone() {
        ...
        try {
            m1 = (javax.vecmath.Matrix3d) super.clone();
