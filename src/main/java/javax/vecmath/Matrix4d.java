...
public class Matrix4d implements java.io.Serializable, Cloneable {
    ...
    */
     ...
     */
    public Matrix4d(javax.vecmath.Matrix4d m1) {
        this.m00 = m1.m00;
        this.m01 = m1.m01;
        this.m02 = m1.m02;
        this.m03 = m1.m03;
     ...
     */
    public final void getRow(int row, javax.vecmath.Vector4d v) {
        if (row == 0) {
            v.x = m00;
            v.y = m01;
            v.z = m02;
     ...
     */
    public final void getColumn(int column, javax.vecmath.Vector4d v) {
        if (column == 0) {
            v.x = m00;
            v.y = m10;
            v.z = m20;
     ...
     */
    public final void setRow(int row, javax.vecmath.Vector4d v) {
        switch (row) {
            case 0:
                this.m00 = v.x;
                this.m01 = v.y;
     ...
     */
    public final void add(double scalar, javax.vecmath.Matrix4d m1) {
     ...
     */
    public final void add(javax.vecmath.Matrix4d m1, javax.vecmath.Matrix4d m2) {
     ...
     */
    public final void add(javax.vecmath.Matrix4d m1) {
        this.m00 += m1.m00;
        this.m01 += m1.m01;
        this.m02 += m1.m02;
        this.m03 += m1.m03;
     ...
     * @param m2 the second matrix
     */
    public final void sub(javax.vecmath.Matrix4d m1, javax.vecmath.Matrix4d m2) {
        this.m00 = m1.m00 - m2.m00;
        this.m01 = m1.m01 - m2.m01;
        this.m02 = m1.m02 - m2.m02;
        this.m03 = m1.m03 - m2.m03;
     ...
     * @param m1 the other matrix
     */
    public final void sub(javax.vecmath.Matrix4d m1) {
        this.m00 -= m1.m00;
        this.m01 -= m1.m01;
        this.m02 -= m1.m02;
        this.m03 -= m1.m03;
     ...
     */
    public final void transpose(javax.vecmath.Matrix4d m1) {
        if (this != m1) {
            this.m00 = m1.m00;
            this.m01 = m1.m10;
            this.m02 = m1.m20;
     ...
     */
    public final void invert(javax.vecmath.Matrix4d m1) {
     ...
     */
    final void invertGeneral(javax.vecmath.Matrix4d m1) {
        ...
        if (!luDecomposition(tmp, row_perm)) {
            ...
            throw new SingularMatrixException(javax.vecmath.VecMathI18N.getString("Matrix4d10"));
        }
     ...
     */
    public final void mul(double scalar, javax.vecmath.Matrix4d m1) {
        this.m00 = m1.m00 * scalar;
        this.m01 = m1.m01 * scalar;
        this.m02 = m1.m02 * scalar;
        this.m03 = m1.m03 * scalar;
     ...
     * @param m1 the other matrix
     */
    public final void mul(javax.vecmath.Matrix4d m1) {
     ...
     * @param m2 the second matrix
     */
    public final void mul(javax.vecmath.Matrix4d m1, javax.vecmath.Matrix4d m2) {
        if (this != m1 && this != m2) {
            // code for mat mul
     ...
     */
    public final void mulTransposeBoth(javax.vecmath.Matrix4d m1, javax.vecmath.Matrix4d m2) {
        if (this != m1 && this != m2) {
     ...
     * @param m2 the matrix on the right hand side of the multiplication
     */
    public final void mulTransposeRight(javax.vecmath.Matrix4d m1, javax.vecmath.Matrix4d m2) {
        if (this != m1 && this != m2) {
     ...
     * @param m2 the matrix on the right hand side of the multiplication
     */
    public final void mulTransposeLeft(javax.vecmath.Matrix4d m1, javax.vecmath.Matrix4d m2) {
        if (this != m1 && this != m2) {
     ...
     */
    public boolean equals(javax.vecmath.Matrix4d m1) {
        try {
    ...
    public boolean equals(Object t1) {
        try {
            javax.vecmath.Matrix4d m2 = (javax.vecmath.Matrix4d) t1;
     ...
     */
    public boolean epsilonEquals(javax.vecmath.Matrix4d m1, float epsilon) {
     ...
     */
    public boolean epsilonEquals(javax.vecmath.Matrix4d m1, double epsilon) {
        double diff;
    ...
    public int hashCode() {
        long bits = 1L;
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, m00);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, m01);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, m02);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, m03);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, m10);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, m11);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, m12);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, m13);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, m20);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, m21);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, m22);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, m23);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, m30);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, m31);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, m32);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, m33);
     ...
     * @param m1 the source matrix
     */
    public final void negate(javax.vecmath.Matrix4d m1) {
        this.m00 = -m1.m00;
        this.m01 = -m1.m01;
        this.m02 = -m1.m02;
        this.m03 = -m1.m03;
    ...
    public Object clone() {
        ...
        try {
            m1 = (javax.vecmath.Matrix4d) super.clone();
