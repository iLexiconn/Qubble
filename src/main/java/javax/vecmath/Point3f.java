 ...
 * x,y,z coordinates.
 */
public class Point3f extends javax.vecmath.Tuple3f implements java.io.Serializable {
     ...
     */
    public Point3f(javax.vecmath.Point3f p1) {
        super(p1);
    }
     ...
     */
    public final float distanceSquared(javax.vecmath.Point3f p1) {
        float dx, dy, dz;
     ...
     * @return the distance
     */
    public final float distance(javax.vecmath.Point3f p1) {
        float dx, dy, dz;
     ...
     */
    public final float distanceL1(javax.vecmath.Point3f p1) {
     ...
     */
    public final float distanceLinf(javax.vecmath.Point3f p1) {
        float tmp;
