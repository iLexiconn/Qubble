...
public class Point3d extends Tuple3d implements java.io.Serializable {
     ...
     */
    public Point3d(javax.vecmath.Point3d p1) {
        super(p1);
    }
     ...
     */
    public final double distanceSquared(javax.vecmath.Point3d p1) {
        double dx, dy, dz;
     ...
     * @return the distance
     */
    public final double distance(javax.vecmath.Point3d p1) {
        double dx, dy, dz;
     ...
     */
    public final double distanceL1(javax.vecmath.Point3d p1) {
     ...
     */
    public final double distanceLinf(javax.vecmath.Point3d p1) {
        double tmp;
