...
public abstract class Tuple3i implements java.io.Serializable, Cloneable {
     ...
     *           data.
     */
    public Tuple3i(javax.vecmath.Tuple3i t1) {
        this.x = t1.x;
        this.y = t1.y;
        this.z = t1.z;
    }
     ...
     */
    public final void set(javax.vecmath.Tuple3i t1) {
        this.x = t1.x;
        this.y = t1.y;
        this.z = t1.z;
    }
     ...
     */
    public final void get(javax.vecmath.Tuple3i t) {
        t.x = this.x;
        t.y = this.y;
        t.z = this.z;
    }
     ...
     */
    public final void add(javax.vecmath.Tuple3i t1, javax.vecmath.Tuple3i t2) {
        this.x = t1.x + t2.x;
        this.y = t1.y + t2.y;
        this.z = t1.z + t2.z;
    }
     ...
     */
    public final void add(javax.vecmath.Tuple3i t1) {
        this.x += t1.x;
        this.y += t1.y;
        this.z += t1.z;
    }
     ...
     * @param t2 the second tuple
     */
    public final void sub(javax.vecmath.Tuple3i t1, javax.vecmath.Tuple3i t2) {
        this.x = t1.x - t2.x;
        this.y = t1.y - t2.y;
        this.z = t1.z - t2.z;
    }
     ...
     * @param t1 the other tuple
     */
    public final void sub(javax.vecmath.Tuple3i t1) {
        this.x -= t1.x;
        this.y -= t1.y;
        this.z -= t1.z;
    }
     ...
     */
    public final void negate(javax.vecmath.Tuple3i t1) {
        this.x = -t1.x;
        this.y = -t1.y;
        this.z = -t1.z;
    }
     ...
     * @param t1 the source tuple
     */
    public final void scale(int s, javax.vecmath.Tuple3i t1) {
        this.x = s * t1.x;
        this.y = s * t1.y;
        this.z = s * t1.z;
    }
     ...
     */
    public final void scaleAdd(int s, javax.vecmath.Tuple3i t1, javax.vecmath.Tuple3i t2) {
        this.x = s * t1.x + t2.x;
        this.y = s * t1.y + t2.y;
        this.z = s * t1.z + t2.z;
    }
     ...
     */
    public final void scaleAdd(int s, javax.vecmath.Tuple3i t1) {
    ...
    public boolean equals(Object t1) {
        try {
            javax.vecmath.Tuple3i t2 = (javax.vecmath.Tuple3i) t1;
     ...
     */
    public final void clamp(int min, int max, javax.vecmath.Tuple3i t) {
        if (t.x > max) {
            x = max;
        } else if (t.x < min) {
            x = min;
     ...
     * @param t   the source tuple, which will not be modified
     */
    public final void clampMin(int min, javax.vecmath.Tuple3i t) {
        if (t.x < min) {
            x = min;
        } else {
            x = t.x;
     ...
     * @param t   the source tuple, which will not be modified
     */
    public final void clampMax(int max, javax.vecmath.Tuple3i t) {
        if (t.x > max) {
            x = max;
        } else {
            x = t.x;
     ...
     * @param t the source tuple, which will not be modified
     */
    public final void absolute(javax.vecmath.Tuple3i t) {
        x = Math.abs(t.x);
        y = Math.abs(t.y);
        z = Math.abs(t.z);
    }
