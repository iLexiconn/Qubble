...
public class Point4d extends Tuple4d implements java.io.Serializable {
     ...
     */
    public Point4d(javax.vecmath.Point4d p1) {
        super(p1);
    }
     ...
     */
    public final double distanceSquared(javax.vecmath.Point4d p1) {
        double dx, dy, dz, dw;
     ...
     */
    public final double distance(javax.vecmath.Point4d p1) {
        double dx, dy, dz, dw;
     ...
     */
    public final double distanceL1(javax.vecmath.Point4d p1) {
     ...
     */
    public final double distanceLinf(javax.vecmath.Point4d p1) {
        double t1, t2;
     ...
     */
    public final void project(javax.vecmath.Point4d p1) {
        double oneOw;
