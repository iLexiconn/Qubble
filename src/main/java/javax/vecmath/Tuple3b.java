...
public abstract class Tuple3b implements java.io.Serializable, Cloneable {
     ...
     */
    public Tuple3b(javax.vecmath.Tuple3b t1) {
        this.x = t1.x;
        this.y = t1.y;
        this.z = t1.z;
    }
     ...
     */
    public final void get(javax.vecmath.Tuple3b t1) {
        t1.x = this.x;
        t1.y = this.y;
        t1.z = this.z;
    }
     ...
     */
    public final void set(javax.vecmath.Tuple3b t1) {
        this.x = t1.x;
        this.y = t1.y;
        this.z = t1.z;
    }
     ...
     */
    public boolean equals(javax.vecmath.Tuple3b t1) {
        try {
    ...
    public boolean equals(Object t1) {
        try {
            javax.vecmath.Tuple3b t2 = (javax.vecmath.Tuple3b) t1;
