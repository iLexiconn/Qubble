...
public abstract class Tuple4i implements java.io.Serializable, Cloneable {
     ...
     *           and w data.
     */
    public Tuple4i(javax.vecmath.Tuple4i t1) {
        this.x = t1.x;
        this.y = t1.y;
        this.z = t1.z;
        this.w = t1.w;
     ...
     */
    public final void set(javax.vecmath.Tuple4i t1) {
        this.x = t1.x;
        this.y = t1.y;
        this.z = t1.z;
        this.w = t1.w;
     ...
     */
    public final void get(javax.vecmath.Tuple4i t) {
        t.x = this.x;
        t.y = this.y;
        t.z = this.z;
        t.w = this.w;
     ...
     */
    public final void add(javax.vecmath.Tuple4i t1, javax.vecmath.Tuple4i t2) {
        this.x = t1.x + t2.x;
        this.y = t1.y + t2.y;
        this.z = t1.z + t2.z;
        this.w = t1.w + t2.w;
     ...
     */
    public final void add(javax.vecmath.Tuple4i t1) {
        this.x += t1.x;
        this.y += t1.y;
        this.z += t1.z;
        this.w += t1.w;
     ...
     * @param t2 the second tuple
     */
    public final void sub(javax.vecmath.Tuple4i t1, javax.vecmath.Tuple4i t2) {
        this.x = t1.x - t2.x;
        this.y = t1.y - t2.y;
        this.z = t1.z - t2.z;
        this.w = t1.w - t2.w;
     ...
     * @param t1 the other tuple
     */
    public final void sub(javax.vecmath.Tuple4i t1) {
        this.x -= t1.x;
        this.y -= t1.y;
        this.z -= t1.z;
        this.w -= t1.w;
     ...
     */
    public final void negate(javax.vecmath.Tuple4i t1) {
        this.x = -t1.x;
        this.y = -t1.y;
        this.z = -t1.z;
        this.w = -t1.w;
     ...
     * @param t1 the source tuple
     */
    public final void scale(int s, javax.vecmath.Tuple4i t1) {
        this.x = s * t1.x;
        this.y = s * t1.y;
        this.z = s * t1.z;
        this.w = s * t1.w;
     ...
     */
    public final void scaleAdd(int s, javax.vecmath.Tuple4i t1, javax.vecmath.Tuple4i t2) {
        this.x = s * t1.x + t2.x;
        this.y = s * t1.y + t2.y;
        this.z = s * t1.z + t2.z;
        this.w = s * t1.w + t2.w;
     ...
     */
    public final void scaleAdd(int s, javax.vecmath.Tuple4i t1) {
    ...
    public boolean equals(Object t1) {
        try {
            javax.vecmath.Tuple4i t2 = (javax.vecmath.Tuple4i) t1;
     ...
     */
    public final void clamp(int min, int max, javax.vecmath.Tuple4i t) {
        if (t.x > max) {
            x = max;
        } else if (t.x < min) {
            x = min;
     ...
     * @param t   the source tuple, which will not be modified
     */
    public final void clampMin(int min, javax.vecmath.Tuple4i t) {
        if (t.x < min) {
            x = min;
        } else {
            x = t.x;
     ...
     * @param t   the source tuple, which will not be modified
     */
    public final void clampMax(int max, javax.vecmath.Tuple4i t) {
        if (t.x > max) {
            x = max;
        } else {
            x = t.x;
     ...
     * @param t the source tuple, which will not be modified
     */
    public final void absolute(javax.vecmath.Tuple4i t) {
        x = Math.abs(t.x);
        y = Math.abs(t.y);
        z = Math.abs(t.z);
        w = Math.abs(t.w);
