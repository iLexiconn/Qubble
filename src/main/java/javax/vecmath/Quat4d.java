...
public class Quat4d extends Tuple4d implements java.io.Serializable {
     ...
     */
    public Quat4d(javax.vecmath.Quat4d q1) {
        super(q1);
    }
     ...
     */
    public final void conjugate(javax.vecmath.Quat4d q1) {
        this.x = -q1.x;
        this.y = -q1.y;
        this.z = -q1.z;
        this.w = q1.w;
     ...
     */
    public final void mul(javax.vecmath.Quat4d q1, javax.vecmath.Quat4d q2) {
        if (this != q1 && this != q2) {
     ...
     */
    public final void mul(javax.vecmath.Quat4d q1) {
        double x, y, w;
     ...
     * @param q2 the second quaternion
     */
    public final void mulInverse(javax.vecmath.Quat4d q1, javax.vecmath.Quat4d q2) {
        javax.vecmath.Quat4d tempQuat = new javax.vecmath.Quat4d(q2);
     ...
     * @param q1 the other quaternion
     */
    public final void mulInverse(javax.vecmath.Quat4d q1) {
        javax.vecmath.Quat4d tempQuat = new javax.vecmath.Quat4d(q1);
     ...
     */
    public final void inverse(javax.vecmath.Quat4d q1) {
        double norm;
     ...
     */
    public final void normalize(javax.vecmath.Quat4d q1) {
        double norm;
     ...
     */
    public final void interpolate(javax.vecmath.Quat4d q1, double alpha) {
     ...
     * @param alpha the alpha interpolation parameter
     */
    public final void interpolate(javax.vecmath.Quat4d q1, javax.vecmath.Quat4d q2, double alpha) {
        // From "Advanced Animation and Rendering Techniques"
        // by Watt and Watt pg. 364, function as implemented appeared to be
        // incorrect.  Fails to choose the same quaternion for the double
        // covering. Resulting in change of direction for rotations.
