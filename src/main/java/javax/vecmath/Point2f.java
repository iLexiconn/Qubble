...
public class Point2f extends Tuple2f implements java.io.Serializable {
     ...
     */
    public Point2f(javax.vecmath.Point2f p1) {
        super(p1);
    }
     ...
     */
    public final float distanceSquared(javax.vecmath.Point2f p1) {
        float dx, dy;
     ...
     * @param p1 the other point
     */
    public final float distance(javax.vecmath.Point2f p1) {
        float dx, dy;
     ...
     * @param p1 the other point
     */
    public final float distanceL1(javax.vecmath.Point2f p1) {
     ...
     * @param p1 the other point
     */
    public final float distanceLinf(javax.vecmath.Point2f p1) {
