...
public abstract class Tuple4f implements java.io.Serializable, Cloneable {
     ...
     */
    public Tuple4f(javax.vecmath.Tuple4f t1) {
        this.x = t1.x;
        this.y = t1.y;
        this.z = t1.z;
        this.w = t1.w;
     ...
     */
    public final void set(javax.vecmath.Tuple4f t1) {
        this.x = t1.x;
        this.y = t1.y;
        this.z = t1.z;
        this.w = t1.w;
     ...
     */
    public final void get(javax.vecmath.Tuple4f t) {
        t.x = this.x;
        t.y = this.y;
        t.z = this.z;
        t.w = this.w;
     ...
     */
    public final void add(javax.vecmath.Tuple4f t1, javax.vecmath.Tuple4f t2) {
        this.x = t1.x + t2.x;
        this.y = t1.y + t2.y;
        this.z = t1.z + t2.z;
        this.w = t1.w + t2.w;
     ...
     */
    public final void add(javax.vecmath.Tuple4f t1) {
        this.x += t1.x;
        this.y += t1.y;
        this.z += t1.z;
        this.w += t1.w;
     ...
     * @param t2 the second tuple
     */
    public final void sub(javax.vecmath.Tuple4f t1, javax.vecmath.Tuple4f t2) {
        this.x = t1.x - t2.x;
        this.y = t1.y - t2.y;
        this.z = t1.z - t2.z;
        this.w = t1.w - t2.w;
     ...
     * @param t1 the other tuple
     */
    public final void sub(javax.vecmath.Tuple4f t1) {
        this.x -= t1.x;
        this.y -= t1.y;
        this.z -= t1.z;
        this.w -= t1.w;
     ...
     */
    public final void negate(javax.vecmath.Tuple4f t1) {
        this.x = -t1.x;
        this.y = -t1.y;
        this.z = -t1.z;
        this.w = -t1.w;
     ...
     * @param t1 the source tuple
     */
    public final void scale(float s, javax.vecmath.Tuple4f t1) {
        this.x = s * t1.x;
        this.y = s * t1.y;
        this.z = s * t1.z;
        this.w = s * t1.w;
     ...
     */
    public final void scaleAdd(float s, javax.vecmath.Tuple4f t1, javax.vecmath.Tuple4f t2) {
        this.x = s * t1.x + t2.x;
        this.y = s * t1.y + t2.y;
        this.z = s * t1.z + t2.z;
        this.w = s * t1.w + t2.w;
     ...
     */
    public final void scaleAdd(float s, javax.vecmath.Tuple4f t1) {
     ...
     */
    public boolean equals(javax.vecmath.Tuple4f t1) {
        try {
    ...
    public boolean equals(Object t1) {
        try {
            javax.vecmath.Tuple4f t2 = (javax.vecmath.Tuple4f) t1;
     ...
     * @return true or false
     */
    public boolean epsilonEquals(javax.vecmath.Tuple4f t1, float epsilon) {
        float diff;
     ...
     */
    public final void clamp(float min, float max, javax.vecmath.Tuple4f t) {
        if (t.x > max) {
            x = max;
        } else if (t.x < min) {
            x = min;
     ...
     * @param t   the source tuple, which will not be modified
     */
    public final void clampMin(float min, javax.vecmath.Tuple4f t) {
        if (t.x < min) {
            x = min;
        } else {
            x = t.x;
     ...
     * @param t   the source tuple, which will not be modified
     */
    public final void clampMax(float max, javax.vecmath.Tuple4f t) {
        if (t.x > max) {
            x = max;
        } else {
            x = t.x;
     ...
     * @param t the source tuple, which will not be modified
     */
    public final void absolute(javax.vecmath.Tuple4f t) {
        x = Math.abs(t.x);
        y = Math.abs(t.y);
        z = Math.abs(t.z);
        w = Math.abs(t.w);
     ...
     */
    public void interpolate(javax.vecmath.Tuple4f t1, javax.vecmath.Tuple4f t2, float alpha) {
     ...
     * @param alpha the alpha interpolation parameter
     */
    public void interpolate(javax.vecmath.Tuple4f t1, float alpha) {
