...
public abstract class Tuple4d implements java.io.Serializable, Cloneable {
     ...
     */
    public Tuple4d(javax.vecmath.Tuple4d t1) {
        this.x = t1.x;
        this.y = t1.y;
        this.z = t1.z;
        this.w = t1.w;
     ...
     */
    public Tuple4d(javax.vecmath.Tuple4f t1) {
        this.x = t1.x;
        this.y = t1.y;
        this.z = t1.z;
        this.w = t1.w;
     ...
     */
    public final void set(javax.vecmath.Tuple4d t1) {
        this.x = t1.x;
        this.y = t1.y;
        this.z = t1.z;
        this.w = t1.w;
     ...
     */
    public final void get(javax.vecmath.Tuple4d t) {
        t.x = this.x;
        t.y = this.y;
        t.z = this.z;
        t.w = this.w;
     ...
     */
    public final void add(javax.vecmath.Tuple4d t1, javax.vecmath.Tuple4d t2) {
        this.x = t1.x + t2.x;
        this.y = t1.y + t2.y;
        this.z = t1.z + t2.z;
        this.w = t1.w + t2.w;
     ...
     */
    public final void add(javax.vecmath.Tuple4d t1) {
        this.x += t1.x;
        this.y += t1.y;
        this.z += t1.z;
        this.w += t1.w;
     ...
     * @param t2 the second tuple
     */
    public final void sub(javax.vecmath.Tuple4d t1, javax.vecmath.Tuple4d t2) {
        this.x = t1.x - t2.x;
        this.y = t1.y - t2.y;
        this.z = t1.z - t2.z;
        this.w = t1.w - t2.w;
     ...
     * @param t1 the other tuple
     */
    public final void sub(javax.vecmath.Tuple4d t1) {
        this.x -= t1.x;
        this.y -= t1.y;
        this.z -= t1.z;
        this.w -= t1.w;
     ...
     */
    public final void negate(javax.vecmath.Tuple4d t1) {
        this.x = -t1.x;
        this.y = -t1.y;
        this.z = -t1.z;
        this.w = -t1.w;
     ...
     * @param t1 the source tuple
     */
    public final void scale(double s, javax.vecmath.Tuple4d t1) {
        this.x = s * t1.x;
        this.y = s * t1.y;
        this.z = s * t1.z;
        this.w = s * t1.w;
     ...
     */
    public final void scaleAdd(double s, javax.vecmath.Tuple4d t1, javax.vecmath.Tuple4d t2) {
        this.x = s * t1.x + t2.x;
        this.y = s * t1.y + t2.y;
        this.z = s * t1.z + t2.z;
        this.w = s * t1.w + t2.w;
     ...
     */
    public final void scaleAdd(float s, javax.vecmath.Tuple4d t1) {
     ...
     */
    public final void scaleAdd(double s, javax.vecmath.Tuple4d t1) {
     ...
     */
    public boolean equals(javax.vecmath.Tuple4d t1) {
        try {
    ...
    public boolean equals(Object t1) {
        try {
            ...
            javax.vecmath.Tuple4d t2 = (javax.vecmath.Tuple4d) t1;
     ...
     * @return true or false
     */
    public boolean epsilonEquals(javax.vecmath.Tuple4d t1, double epsilon) {
        double diff;
    ...
    public int hashCode() {
        long bits = 1L;
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, x);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, y);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, z);
        bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, w);
     ...
     */
    public final void clamp(float min, float max, javax.vecmath.Tuple4d t) {
     ...
     */
    public final void clamp(double min, double max, javax.vecmath.Tuple4d t) {
        if (t.x > max) {
            x = max;
        } else if (t.x < min) {
            x = min;
     ...
     */
    public final void clampMin(float min, javax.vecmath.Tuple4d t) {
     ...
     * @param t   the source tuple, which will not be modified
     */
    public final void clampMin(double min, javax.vecmath.Tuple4d t) {
        if (t.x < min) {
            x = min;
        } else {
            x = t.x;
     ...
     */
    public final void clampMax(float max, javax.vecmath.Tuple4d t) {
     ...
     * @param t   the source tuple, which will not be modified
     */
    public final void clampMax(double max, javax.vecmath.Tuple4d t) {
        if (t.x > max) {
            x = max;
        } else {
            x = t.x;
     ...
     * @param t the source tuple, which will not be modified
     */
    public final void absolute(javax.vecmath.Tuple4d t) {
        x = Math.abs(t.x);
        y = Math.abs(t.y);
        z = Math.abs(t.z);
        w = Math.abs(t.w);
     ...
     */
    public void interpolate(javax.vecmath.Tuple4d t1, javax.vecmath.Tuple4d t2, float alpha) {
     ...
     */
    public void interpolate(javax.vecmath.Tuple4d t1, javax.vecmath.Tuple4d t2, double alpha) {
     ...
     */
    public void interpolate(javax.vecmath.Tuple4d t1, float alpha) {
     ...
     * @param alpha the alpha interpolation parameter
     */
    public void interpolate(javax.vecmath.Tuple4d t1, double alpha) {
