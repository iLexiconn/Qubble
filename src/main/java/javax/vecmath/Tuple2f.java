...
public abstract class Tuple2f implements java.io.Serializable, Cloneable {
     ...
     */
    public final void add(javax.vecmath.Tuple2f t1, javax.vecmath.Tuple2f t2) {
        this.x = t1.x + t2.x;
        this.y = t1.y + t2.y;
    }
     ...
     * @param t2 the second tuple
     */
    public final void sub(javax.vecmath.Tuple2f t1, javax.vecmath.Tuple2f t2) {
        this.x = t1.x - t2.x;
        this.y = t1.y - t2.y;
    }
     ...
     * @param t1 the source tuple
     */
    public final void scale(float s, javax.vecmath.Tuple2f t1) {
        this.x = s * t1.x;
        this.y = s * t1.y;
    }
     ...
     */
    public final void scaleAdd(float s, javax.vecmath.Tuple2f t1, javax.vecmath.Tuple2f t2) {
        this.x = s * t1.x + t2.x;
        this.y = s * t1.y + t2.y;
    }
     ...
     */
    public final void scaleAdd(float s, javax.vecmath.Tuple2f t1) {
    ...
    public boolean equals(Object t1) {
        try {
            javax.vecmath.Tuple2f t2 = (javax.vecmath.Tuple2f) t1;
     ...
     * @return true or false
     */
    public boolean epsilonEquals(javax.vecmath.Tuple2f t1, float epsilon) {
        float diff;
     ...
     */
    public final void clamp(float min, float max, javax.vecmath.Tuple2f t) {
        if (t.x > max) {
            x = max;
        } else if (t.x < min) {
            x = min;
     ...
     * @param t   the source tuple, which will not be modified
     */
    public final void clampMin(float min, javax.vecmath.Tuple2f t) {
        if (t.x < min) {
            x = min;
        } else {
            x = t.x;
     ...
     * @param t   the source tuple, which will not be modified
     */
    public final void clampMax(float max, javax.vecmath.Tuple2f t) {
        if (t.x > max) {
            x = max;
        } else {
            x = t.x;
     ...
     */
    public final void interpolate(javax.vecmath.Tuple2f t1, javax.vecmath.Tuple2f t2, float alpha) {
     ...
     * @param alpha the alpha interpolation parameter
     */
    public final void interpolate(javax.vecmath.Tuple2f t1, float alpha) {
