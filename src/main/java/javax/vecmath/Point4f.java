...
public class Point4f extends Tuple4f implements java.io.Serializable {
     ...
     */
    public Point4f(javax.vecmath.Point4f p1) {
        super(p1);
    }
     ...
     */
    public final float distanceSquared(javax.vecmath.Point4f p1) {
        float dx, dy, dz, dw;
     ...
     */
    public final float distance(javax.vecmath.Point4f p1) {
        float dx, dy, dz, dw;
     ...
     */
    public final float distanceL1(javax.vecmath.Point4f p1) {
     ...
     */
    public final float distanceLinf(javax.vecmath.Point4f p1) {
        float t1, t2;
     ...
     */
    public final void project(javax.vecmath.Point4f p1) {
        float oneOw;
