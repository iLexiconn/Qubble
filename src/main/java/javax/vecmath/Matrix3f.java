...
public class Matrix3f implements java.io.Serializable, Cloneable {
    ...
    */
     ...
     */
    public final void getRow(int row, javax.vecmath.Vector3f v) {
        if (row == 0) {
            v.x = m00;
            v.y = m01;
            v.z = m02;
     ...
     * @param v      the vector into which the matrix row values will be copied
     */
    public final void getColumn(int column, javax.vecmath.Vector3f v) {
        if (column == 0) {
            v.x = m00;
            v.y = m10;
            v.z = m20;
     ...
     */
    public final void setRow(int row, javax.vecmath.Vector3f v) {
        switch (row) {
            case 0:
                this.m00 = v.x;
                this.m01 = v.y;
     ...
     */
    public final void add(float scalar, javax.vecmath.Matrix3f m1) {
     ...
     */
    public final void add(javax.vecmath.Matrix3f m1, javax.vecmath.Matrix3f m2) {
     ...
     * @param m2 the second matrix
     */
    public final void sub(javax.vecmath.Matrix3f m1, javax.vecmath.Matrix3f m2) {
        this.m00 = m1.m00 - m2.m00;
        this.m01 = m1.m01 - m2.m01;
        this.m02 = m1.m02 - m2.m02;
     ...
     */
    private final void invertGeneral(javax.vecmath.Matrix3f m1) {
        ...
        if (!luDecomposition(temp, row_perm)) {
            ...
            throw new SingularMatrixException(javax.vecmath.VecMathI18N.getString("Matrix3f12"));
        }
     ...
     */
    public final void mul(float scalar, javax.vecmath.Matrix3f m1) {
     ...
     * @param m2 the second matrix
     */
    public final void mul(javax.vecmath.Matrix3f m1, javax.vecmath.Matrix3f m2) {
        if (this != m1 && this != m2) {
     ...
     */
    public final void mulNormalize(javax.vecmath.Matrix3f m1, javax.vecmath.Matrix3f m2) {
     ...
     * @param m2 the matrix on the right hand side of the multiplication
     */
    public final void mulTransposeBoth(javax.vecmath.Matrix3f m1, javax.vecmath.Matrix3f m2) {
        if (this != m1 && this != m2) {
     ...
     * @param m2 the matrix on the right hand side of the multiplication
     */
    public final void mulTransposeRight(javax.vecmath.Matrix3f m1, javax.vecmath.Matrix3f m2) {
        if (this != m1 && this != m2) {
     ...
     * @param m2 the matrix on the right hand side of the multiplication
     */
    public final void mulTransposeLeft(javax.vecmath.Matrix3f m1, javax.vecmath.Matrix3f m2) {
        if (this != m1 && this != m2) {
    ...
    public boolean equals(Object o1) {
        try {
            ...
            javax.vecmath.Matrix3f m2 = (javax.vecmath.Matrix3f) o1;
     ...
     */
    public boolean epsilonEquals(javax.vecmath.Matrix3f m1, float epsilon) {
        boolean status = true;
    ...
    public int hashCode() {
        long bits = 1L;
        bits = javax.vecmath.VecMathUtil.hashFloatBits(bits, m00);
        bits = javax.vecmath.VecMathUtil.hashFloatBits(bits, m01);
        bits = javax.vecmath.VecMathUtil.hashFloatBits(bits, m02);
        bits = javax.vecmath.VecMathUtil.hashFloatBits(bits, m10);
        bits = javax.vecmath.VecMathUtil.hashFloatBits(bits, m11);
        bits = javax.vecmath.VecMathUtil.hashFloatBits(bits, m12);
        bits = javax.vecmath.VecMathUtil.hashFloatBits(bits, m20);
        bits = javax.vecmath.VecMathUtil.hashFloatBits(bits, m21);
        bits = javax.vecmath.VecMathUtil.hashFloatBits(bits, m22);
    ...
    public Object clone() {
        ...
        try {
            m1 = (javax.vecmath.Matrix3f) super.clone();
