...
public abstract class Tuple3d implements java.io.Serializable, Cloneable {
     ...
     */
    public Tuple3d(javax.vecmath.Tuple3d t1) {
        this.x = t1.x;
        this.y = t1.y;
        this.z = t1.z;
    }
     ...
     */
    public Tuple3d(javax.vecmath.Tuple3f t1) {
        this.x = (double) t1.x;
        this.y = (double) t1.y;
        this.z = (double) t1.z;
    }
     ...
     */
    public final void set(javax.vecmath.Tuple3d t1) {
        this.x = t1.x;
        this.y = t1.y;
        this.z = t1.z;
    }
     ...
     * @param t1 the tuple to be copied
     */
    public final void set(javax.vecmath.Tuple3f t1) {
        this.x = (double) t1.x;
        this.y = (double) t1.y;
        this.z = (double) t1.z;
    }
     ...
     */
    public final void get(javax.vecmath.Tuple3d t) {
        t.x = this.x;
        t.y = this.y;
        t.z = this.z;
    }
     ...
     */
    public final void add(javax.vecmath.Tuple3d t1, javax.vecmath.Tuple3d t2) {
        this.x = t1.x + t2.x;
        this.y = t1.y + t2.y;
        this.z = t1.z + t2.z;
    }
     ...
     */
    public final void add(javax.vecmath.Tuple3d t1) {
        this.x += t1.x;
        this.y += t1.y;
        this.z += t1.z;
    }
     ...
     * @param t2 the second tuple
     */
    public final void sub(javax.vecmath.Tuple3d t1, javax.vecmath.Tuple3d t2) {
        this.x = t1.x - t2.x;
        this.y = t1.y - t2.y;
        this.z = t1.z - t2.z;
    }
     ...
     * @param t1 the other tuple
     */
    public final void sub(javax.vecmath.Tuple3d t1) {
        this.x -= t1.x;
        this.y -= t1.y;
        this.z -= t1.z;
    }
     ...
     */
    public final void negate(javax.vecmath.Tuple3d t1) {
        this.x = -t1.x;
        this.y = -t1.y;
        this.z = -t1.z;
    }
     ...
     * @param t1 the source tuple
     */
    public final void scale(double s, javax.vecmath.Tuple3d t1) {
        this.x = s * t1.x;
        this.y = s * t1.y;
        this.z = s * t1.z;
    }
     ...
     */
    public final void scaleAdd(double s, javax.vecmath.Tuple3d t1, javax.vecmath.Tuple3d t2) {
        this.x = s * t1.x + t2.x;
        this.y = s * t1.y + t2.y;
        this.z = s * t1.z + t2.z;
    }
     ...
     */
    public final void scaleAdd(double s, javax.vecmath.Tuple3d t1) {
     ...
     */
    public boolean equals(javax.vecmath.Tuple3d t1) {
        try {
    ...
    public boolean equals(Object t1) {
        try {
            javax.vecmath.Tuple3d t2 = (javax.vecmath.Tuple3d) t1;
     ...
     * @return true or false
     */
    public boolean epsilonEquals(javax.vecmath.Tuple3d t1, double epsilon) {
        double diff;
     ...
     */
    public final void clamp(float min, float max, javax.vecmath.Tuple3d t) {
     ...
     */
    public final void clamp(double min, double max, javax.vecmath.Tuple3d t) {
        if (t.x > max) {
            x = max;
        } else if (t.x < min) {
            x = min;
     ...
     */
    public final void clampMin(float min, javax.vecmath.Tuple3d t) {
     ...
     * @param t   the source tuple, which will not be modified
     */
    public final void clampMin(double min, javax.vecmath.Tuple3d t) {
        if (t.x < min) {
            x = min;
        } else {
            x = t.x;
     ...
     */
    public final void clampMax(float max, javax.vecmath.Tuple3d t) {
     ...
     * @param t   the source tuple, which will not be modified
     */
    public final void clampMax(double max, javax.vecmath.Tuple3d t) {
        if (t.x > max) {
            x = max;
        } else {
            x = t.x;
     ...
     * @param t the source tuple, which will not be modified
     */
    public final void absolute(javax.vecmath.Tuple3d t) {
        x = Math.abs(t.x);
        y = Math.abs(t.y);
        z = Math.abs(t.z);
     ...
     */
    public final void interpolate(javax.vecmath.Tuple3d t1, javax.vecmath.Tuple3d t2, float alpha) {
     ...
     */
    public final void interpolate(javax.vecmath.Tuple3d t1, javax.vecmath.Tuple3d t2, double alpha) {
     ...
     */
    public final void interpolate(javax.vecmath.Tuple3d t1, float alpha) {
     ...
     * @param alpha the alpha interpolation parameter
     */
    public final void interpolate(javax.vecmath.Tuple3d t1, double alpha) {
