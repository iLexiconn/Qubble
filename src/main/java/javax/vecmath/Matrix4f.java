...
public class Matrix4f implements java.io.Serializable, Cloneable {
    ...
    */
     ...
     * @param m1 the source matrix
     */
    public Matrix4f(javax.vecmath.Matrix4f m1) {
        this.m00 = m1.m00;
        this.m01 = m1.m01;
        this.m02 = m1.m02;
        this.m03 = m1.m03;
     ...
     */
    public final void add(float scalar, javax.vecmath.Matrix4f m1) {
     ...
     */
    public final void add(javax.vecmath.Matrix4f m1, javax.vecmath.Matrix4f m2) {
     ...
     */
    public final void add(javax.vecmath.Matrix4f m1) {
        this.m00 += m1.m00;
        this.m01 += m1.m01;
        this.m02 += m1.m02;
        this.m03 += m1.m03;
     ...
     * @param m2 the second matrix
     */
    public final void sub(javax.vecmath.Matrix4f m1, javax.vecmath.Matrix4f m2) {
        this.m00 = m1.m00 - m2.m00;
        this.m01 = m1.m01 - m2.m01;
        this.m02 = m1.m02 - m2.m02;
        this.m03 = m1.m03 - m2.m03;
     ...
     * @param m1 the other matrix
     */
    public final void sub(javax.vecmath.Matrix4f m1) {
        this.m00 -= m1.m00;
        this.m01 -= m1.m01;
        this.m02 -= m1.m02;
        this.m03 -= m1.m03;
     ...
     */
    public final void transpose(javax.vecmath.Matrix4f m1) {
        if (this != m1) {
            this.m00 = m1.m00;
            this.m01 = m1.m10;
            this.m02 = m1.m20;
     ...
     */
    public final void invert(javax.vecmath.Matrix4f m1) {
     ...
     */
    final void invertGeneral(javax.vecmath.Matrix4f m1) {
        ...
        if (!luDecomposition(temp, row_perm)) {
            ...
            throw new SingularMatrixException(javax.vecmath.VecMathI18N.getString("Matrix4f12"));
        }
     ...
     */
    public final void mul(float scalar, javax.vecmath.Matrix4f m1) {
        this.m00 = m1.m00 * scalar;
        this.m01 = m1.m01 * scalar;
        this.m02 = m1.m02 * scalar;
        this.m03 = m1.m03 * scalar;
     ...
     * @param m1 the other matrix
     */
    public final void mul(javax.vecmath.Matrix4f m1) {
     ...
     * @param m2 the second matrix
     */
    public final void mul(javax.vecmath.Matrix4f m1, javax.vecmath.Matrix4f m2) {
        if (this != m1 && this != m2) {
     ...
     */
    public final void mulTransposeBoth(javax.vecmath.Matrix4f m1, javax.vecmath.Matrix4f m2) {
        if (this != m1 && this != m2) {
     ...
     * @param m2 the matrix on the right hand side of the multiplication
     */
    public final void mulTransposeRight(javax.vecmath.Matrix4f m1, javax.vecmath.Matrix4f m2) {
        if (this != m1 && this != m2) {
     ...
     * @param m2 the matrix on the right hand side of the multiplication
     */
    public final void mulTransposeLeft(javax.vecmath.Matrix4f m1, javax.vecmath.Matrix4f m2) {
        if (this != m1 && this != m2) {
     ...
     */
    public boolean equals(javax.vecmath.Matrix4f m1) {
        try {
    ...
    public boolean equals(Object t1) {
        try {
            javax.vecmath.Matrix4f m2 = (javax.vecmath.Matrix4f) t1;
     ...
     */
    public boolean epsilonEquals(javax.vecmath.Matrix4f m1, float epsilon) {
     ...
     * @param m1 the source matrix
     */
    public final void negate(javax.vecmath.Matrix4f m1) {
        this.m00 = -m1.m00;
        this.m01 = -m1.m01;
        this.m02 = -m1.m02;
        this.m03 = -m1.m03;
    ...
    public Object clone() {
        ...
        try {
            m1 = (javax.vecmath.Matrix4f) super.clone();
