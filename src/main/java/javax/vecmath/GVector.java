...
public class GVector implements java.io.Serializable, Cloneable {
     ...
     */
    public GVector(javax.vecmath.GVector vector) {
        int i;
     ...
     */
    public GVector(javax.vecmath.Tuple2f tuple) {
        values = new double[2];
     ...
     */
    public final void normalize(javax.vecmath.GVector v1) {
        double sq = 0.0;
        int i;

        if (length != v1.length) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector0"));
        }
     ...
     */
    public final void scale(double s, javax.vecmath.GVector v1) {
        int i;
        if (length != v1.length) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector1"));
        }
     ...
     */
    public final void scaleAdd(double s, javax.vecmath.GVector v1, javax.vecmath.GVector v2) {

        int i;

        if (v2.length != v1.length) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector2"));
        }

        if (length != v1.length) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector3"));
        }
     ...
     */
    public final void add(javax.vecmath.GVector vector) {
        int i;

        if (length != vector.length) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector4"));
        }
     ...
     */
    public final void add(javax.vecmath.GVector vector1, javax.vecmath.GVector vector2) {
        int i;

        if (vector1.length != vector2.length) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector5"));
        }

        if (length != vector1.length) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector6"));
        }
     ...
     */
    public final void sub(javax.vecmath.GVector vector) {
        int i;

        if (length != vector.length) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector7"));
        }
     ...
     * @param vector2 the second vector
     */
    public final void sub(javax.vecmath.GVector vector1, javax.vecmath.GVector vector2) {
        int i, l;


        if (vector1.length != vector2.length) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector8"));
        }

        if (length != vector1.length) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector9"));
        }
     ...
     */
    public final void mul(GMatrix m1, javax.vecmath.GVector v1) {
        if (m1.getNumCol() != v1.length) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector10"));
        }

        if (length != m1.getNumRow()) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector11"));
        }
     ...
     */
    public final void mul(javax.vecmath.GVector v1, GMatrix m1) {
        if (m1.getNumRow() != v1.length) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector12"));
        }

        if (length != m1.getNumCol()) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector13"));
        }
     ...
     */
    public final void set(javax.vecmath.GVector vector) {
        int i;
    ...
    public int hashCode() {
        ...
        for (int i = 0; i < length; i++) {
            bits = javax.vecmath.VecMathUtil.hashDoubleBits(bits, values[i]);
        }

        return javax.vecmath.VecMathUtil.hashFinish(bits);
    }
     ...
     */
    public boolean equals(javax.vecmath.GVector vector1) {
        try {
            if (length != vector1.length) {
                return false;
            }
    ...
    public boolean equals(Object o1) {
        try {
            javax.vecmath.GVector v2 = (javax.vecmath.GVector) o1;
     ...
     */
    public boolean epsilonEquals(javax.vecmath.GVector v1, double epsilon) {
        double diff;
     ...
     */
    public final double dot(javax.vecmath.GVector v1) {
        if (length != v1.length) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector14"));
        }
     ...
     */
    public final void SVDBackSolve(GMatrix U, GMatrix W, GMatrix V, javax.vecmath.GVector b) {
        if (!(U.nRow == b.getSize() &&
                U.nRow == U.nCol &&
                U.nRow == W.nRow)) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector15"));
        }

        if (!(W.nCol == values.length &&
                W.nCol == V.nCol &&
                W.nCol == V.nRow)) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector23"));
        }
     ...
     */
    public final void LUDBackSolve(GMatrix LU, javax.vecmath.GVector b, javax.vecmath.GVector permutation) {
        ...
        if (LU.nRow != b.getSize()) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector16"));
        }

        if (LU.nRow != permutation.getSize()) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector24"));
        }

        if (LU.nRow != LU.nCol) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector25"));
        }
     ...
     */
    public final double angle(javax.vecmath.GVector v1) {
     ...
     */
    public final void interpolate(javax.vecmath.GVector v1, javax.vecmath.GVector v2, float alpha) {
     ...
     */
    public final void interpolate(javax.vecmath.GVector v1, float alpha) {
     ...
     */
    public final void interpolate(javax.vecmath.GVector v1, javax.vecmath.GVector v2, double alpha) {
        if (v2.length != v1.length) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector20"));
        }

        if (length != v1.length) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector21"));
        }
     ...
     * @param alpha the alpha interpolation parameter
     */
    public final void interpolate(javax.vecmath.GVector v1, double alpha) {
        if (v1.length != length) {
            throw new MismatchedSizeException(javax.vecmath.VecMathI18N.getString("GVector22"));
        }
    ...
    @Override
    public Object clone() {
        javax.vecmath.GVector v1;
        try {
            v1 = (javax.vecmath.GVector) super.clone();
