...
public class GMatrix implements java.io.Serializable, Cloneable {
     ...
     */
    public GMatrix(javax.vecmath.GMatrix matrix) {
        nRow = matrix.nRow;
        nCol = matrix.nCol;
        values = new double[nRow][nCol];
     ...
     */
    public final void mul(javax.vecmath.GMatrix m1) {
        int i, j, k;
     ...
     */
    public final void mul(javax.vecmath.GMatrix m1, javax.vecmath.GMatrix m2) {
        int i, j, k;
     ...
     * @param m1 the other matrix
     */
    public final void add(javax.vecmath.GMatrix m1) {
        int i, j;
     ...
     * @param m2 the second matrix
     */
    public final void add(javax.vecmath.GMatrix m1, javax.vecmath.GMatrix m2) {
        int i, j;
     ...
     * @param m1 the other matrix
     */
    public final void sub(javax.vecmath.GMatrix m1) {
        int i, j;
        if (nRow != m1.nRow) {
            throw new MismatchedSizeException
     ...
     * @param m2 the second matrix
     */
    public final void sub(javax.vecmath.GMatrix m1, javax.vecmath.GMatrix m2) {
        int i, j;
        if (m2.nRow != m1.nRow) {
            throw new MismatchedSizeException
     ...
     */
    public final void negate(javax.vecmath.GMatrix m1) {
        int i, j;
        if (nRow != m1.nRow || nCol != m1.nCol) {
            throw new MismatchedSizeException
     ...
     */
    public final void invert(javax.vecmath.GMatrix m1) {
        invertGeneral(m1);
    }
    ...
    public final void copySubMatrix(int rowSource, int colSource,
                                    ...
                                    int colDest, javax.vecmath.GMatrix target) {
        int i, j;
     ...
     * @param m1 the source matrix
     */
    public final void set(javax.vecmath.GMatrix m1) {
        int i, j;
     ...
     * @param m1 The matrix that will hold the new values
     */
    public final void get(javax.vecmath.GMatrix m1) {
        int i, j, nc, nr;
     ...
     */
    public final void mulTransposeBoth(javax.vecmath.GMatrix m1, javax.vecmath.GMatrix m2) {
        int i, j, k;
     ...
     * @param m2 The matrix on the right hand side of the multiplication
     */
    public final void mulTransposeRight(javax.vecmath.GMatrix m1, javax.vecmath.GMatrix m2) {
        int i, j, k;
     ...
     * @param m2 The matrix on the right hand side of the multiplication
     */
    public final void mulTransposeLeft(javax.vecmath.GMatrix m1, javax.vecmath.GMatrix m2) {
        int i, j, k;
     ...
     */
    public final void transpose(javax.vecmath.GMatrix m1) {
        int i, j;
    ...
    private static void checkMatrix(javax.vecmath.GMatrix m) {
        int i, j;
     ...
     */
    public boolean equals(javax.vecmath.GMatrix m1) {
        try {
            int i, j;
    ...
    public boolean equals(Object o1) {
        try {
            javax.vecmath.GMatrix m2 = (javax.vecmath.GMatrix) o1;
            int i, j;
     ...
     */
    public boolean epsilonEquals(javax.vecmath.GMatrix m1, float epsilon) {
     ...
     */
    public boolean epsilonEquals(javax.vecmath.GMatrix m1, double epsilon) {
        int i, j;
        double diff;
        if (nRow != m1.nRow || nCol != m1.nCol) {
            return false;
     ...
     */
    public final int SVD(javax.vecmath.GMatrix U, javax.vecmath.GMatrix W, javax.vecmath.GMatrix V) {
     ...
     */
    public final int LUD(javax.vecmath.GMatrix LU, GVector permutation) {
     ...
     */
    final void invertGeneral(javax.vecmath.GMatrix m1) {
    ...
    static int computeSVD(javax.vecmath.GMatrix mat, javax.vecmath.GMatrix U, javax.vecmath.GMatrix W, javax.vecmath.GMatrix V) {
        int i, j, k;
        int nr, nc, si;
        ...
        javax.vecmath.GMatrix tmp = new javax.vecmath.GMatrix(mat.nRow, mat.nCol);
        javax.vecmath.GMatrix u = new javax.vecmath.GMatrix(mat.nRow, mat.nCol);
        javax.vecmath.GMatrix v = new javax.vecmath.GMatrix(mat.nRow, mat.nCol);
        javax.vecmath.GMatrix m = new javax.vecmath.GMatrix(mat);
    ...
    static void compute_qr(int start, int end, double[] s, double[] e,
                           javax.vecmath.GMatrix u, javax.vecmath.GMatrix v) {
        ...
        double[] sinl = new double[1];
        double[] sinr = new double[1];
        javax.vecmath.GMatrix m = new javax.vecmath.GMatrix(u.nCol, v.nRow);
    ...
    private static void update_v(int index, javax.vecmath.GMatrix v,
    ...
    private static void chase_up(double[] s, double[] e, int k, javax.vecmath.GMatrix v) {
        double f, g, r;
        double[] cosr = new double[1];
        double[] sinr = new double[1];
        int i;
        javax.vecmath.GMatrix t = new javax.vecmath.GMatrix(v.nRow, v.nCol);
        javax.vecmath.GMatrix m = new javax.vecmath.GMatrix(v.nRow, v.nCol);
    ...
    private static void chase_across(double[] s, double[] e, int k, javax.vecmath.GMatrix u) {
        double f, g, r;
        double[] cosl = new double[1];
        double[] sinl = new double[1];
        int i;
        javax.vecmath.GMatrix t = new javax.vecmath.GMatrix(u.nRow, u.nCol);
        javax.vecmath.GMatrix m = new javax.vecmath.GMatrix(u.nRow, u.nCol);
    ...
    private static void update_v_split(int topr, int bottomr, javax.vecmath.GMatrix v,
                                       double[] cosr, double[] sinr,
                                       javax.vecmath.GMatrix t, javax.vecmath.GMatrix m) {
        int j;
        double vtemp;
    ...
    private static void update_u_split(int topr, int bottomr, javax.vecmath.GMatrix u,
    ...
    private static void update_u(int index, javax.vecmath.GMatrix u,
                                 double[] cosl, double[] sinl) {
        int j;
        double utemp;
    ...
    private static void print_m(javax.vecmath.GMatrix m, javax.vecmath.GMatrix u, javax.vecmath.GMatrix v) {
        javax.vecmath.GMatrix mtmp = new javax.vecmath.GMatrix(m.nCol, m.nRow);
    ...
    private static String toString(javax.vecmath.GMatrix m) {
    ...
    private static void print_svd(double[] s, double[] e,
                                  javax.vecmath.GMatrix u, javax.vecmath.GMatrix v) {
        int i;
        javax.vecmath.GMatrix mtmp = new javax.vecmath.GMatrix(u.nCol, v.nRow);
    ...
    @Override
    public Object clone() {
        javax.vecmath.GMatrix m1;
        try {
            m1 = (javax.vecmath.GMatrix) super.clone();
