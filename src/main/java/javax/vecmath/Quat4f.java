...
public class Quat4f extends Tuple4f implements java.io.Serializable {
     ...
     */
    public final void mul(javax.vecmath.Quat4f q1, javax.vecmath.Quat4f q2) {
        if (this != q1 && this != q2) {
     ...
     * @param q2 the second quaternion
     */
    public final void mulInverse(javax.vecmath.Quat4f q1, javax.vecmath.Quat4f q2) {
        javax.vecmath.Quat4f tempQuat = new javax.vecmath.Quat4f(q2);
    ...
    public final void mulInverse(javax.vecmath.Quat4f q1) {
        javax.vecmath.Quat4f tempQuat = new javax.vecmath.Quat4f(q1);
     ...
     */
    public final void interpolate(javax.vecmath.Quat4f q1, float alpha) {
     ...
     * @param alpha the alpha interpolation parameter
     */
    public final void interpolate(javax.vecmath.Quat4f q1, javax.vecmath.Quat4f q2, float alpha) {
        // From "Advanced Animation and Rendering Techniques"
        // by Watt and Watt pg. 364, function as implemented appeared to be
        // incorrect.  Fails to choose the same quaternion for the double
        // covering. Resulting in change of direction for rotations.
