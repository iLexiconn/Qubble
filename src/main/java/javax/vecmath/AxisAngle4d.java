...
public class AxisAngle4d implements java.io.Serializable, Cloneable {
     ...
     */
    public AxisAngle4d(javax.vecmath.AxisAngle4d a1) {
        this.x = a1.x;
        this.y = a1.y;
        this.z = a1.z;
        this.angle = a1.angle;
     ...
     */
    public boolean equals(javax.vecmath.AxisAngle4d a1) {
        try {
    ...
    public boolean equals(Object o1) {
        try {
            javax.vecmath.AxisAngle4d a2 = (javax.vecmath.AxisAngle4d) o1;
     ...
     */
    public boolean epsilonEquals(javax.vecmath.AxisAngle4d a1, double epsilon) {
        double diff;
